...
namespace akg1my
{
    internal class Drawer
    {
        ...
        protected List<int> Interpolate(int i0, int d0, int i1, int d1)
        {
        ...
        public unsafe void RasterizeTriangle(Point v0, Point v1, Point v2, Color color)
        {
            ...
            var x012 = new List<int>(x01.Count + x12.Count);
            x012.AddRange(x01);
            x012.AddRange(x12);
